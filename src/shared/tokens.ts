...
/**
 * Shared design tokens and primitives. Every component includes this first.
 * Resolution order for each token: host theme variable → runtime value from
 * `salla.config` (set on the host as --shohrah-*) → static fallback.
 */
